...
namespace Fasetto.Word
{
    ...
    public static class StoryBoardHelpers
    {
        ...
        public static void AddSlideFromRight(this Storyboard storyboard, float secs, double offset, float deceleration = 0.9f)
        {
        ...
        /// <param name="offset">the distance to the right to start from</param>
        /// <param name="deceleration">the rate of deceleration</param>
        public static void AddSlideToLeft(this Storyboard storyboard, float secs, double offset, float deceleration = 0.9f)
        {
            // Create the margin animate fromn right
            ThicknessAnimation animation = new ThicknessAnimation
            {
